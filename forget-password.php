...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Forget Password-fushiony</title>  
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			if ($_POST['method'] == 'email'){
				...
				if ($row['COUNT(accountID)'] == 1) {
					...
					$error="ERROR: cannot found user with the provided email address.";
				}
 
			}
			else {
				#reserve for other recover method
			}
		}
	?>
	<!-- Start Reservation -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
					  ...
					  <p>Please enter the email address you used to register the account</p>
							...
							<div class="row">
								...
								<div class="col-md-12">
				  					<div class="submit-button text-center">
										<button class="btn btn-common" id="submit" type="submit">Recover Password</button>
