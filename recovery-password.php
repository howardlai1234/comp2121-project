...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Recover Password-fushiony</title>  
...
<body>
	...
	<?php
		...
		$password = $rePassword = $hash_pw =  $email =  $message = "";
		...
		if (!empty($_SESSION['Temail'])){
			if ($_SERVER["REQUEST_METHOD"] == "POST") {
				...
				if ($password == $rePassword){
					...
					$sql = "UPDATE Account 
							SET passwordHash='$hash_pw'
							WHERE email='$email';";
					if (mysqli_query($conn, $sql)) {
						$message = "Password changed successfully, Please login via the login page.";
						$_SESSION['Temail'] = "";
					}
					else {
						$generalError = "ERROR: Fail change password, please try again later.";
					}
				}
				else{
						$generalError = "ERROR: The password are not identital.";
				}
			}
		}
		else{
		$message = "Your password has already changed, Please login via the login page.";
		}
	?>
	<!-- Start Reservation -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
					  ...
					  <p>We have located your account, Please enter your new password.</p>
					</div>
				</div>
			</div>
			<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="submit-button text-center">
										<button class="btn btn-common" id="submit" type="submit">Recover</button>
